...
public final class SleepDatabase_Impl extends SleepDatabase {
  ...
  protected Map<Class<?>, List<Class<?>>> getRequiredTypeConverters() {
    ...
    _typeConvertersMap.put(SleepSegmentEventDao.class, SleepSegmentEventDao_Impl.getRequiredConverters());
    _typeConvertersMap.put(SleepClassifyEventDao.class, SleepClassifyEventDao_Impl.getRequiredConverters());
